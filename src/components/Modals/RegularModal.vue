<template>
    <div>
      ...
      <div v-if="showModal" class="overflow-x-hidden top-95-px mx-4 px-12 overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none justify-center items-center flex">

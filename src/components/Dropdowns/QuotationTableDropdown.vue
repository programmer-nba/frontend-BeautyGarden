...
export default {
  ...
  methods: {
    ...
    deleteQuotation: async function () {
      this.dropdownPopoverShow = false;
      const id = this.quotation._id
      await axios.delete(`${process.env.VUE_APP_API_BACKEND}/quotation/deleteQuotation/${id}`,
        {
          headers: {

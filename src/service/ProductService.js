...
export const Documents = {
    ...
    async uploadFileQuotation(id, quotationId, formData) {
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/quotation/ImportImgProduct/${id}/${quotationId}`,
                    formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN,
    ...
    async createNewQuotation(formData) {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/quotation/CreateVat`,
                formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN
    ...
    async editQuotation(id, formData) {
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/quotation/EditQuotation/${id}`,
                formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN
    ...
    async createNewReceiptRefInvoice(formData) {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/receiptVat/ReceiptRefInvoice`,
                formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN
    ...
    async uploadFileInvoice(id, invoiceId, formData) {
        try {
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/invoice/ImportImgProduct/${id}/${invoiceId}`,
                    formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN,
    ...
    async createNewInvoice(formData) {
        try {
            const response = await axios.post(`${import.meta.env.VITE_API_URL}/invoice/PrintInviuceVat`,
                formData,
                {
                    headers: {
                        'auth-token': import.meta.env.VITE_TOKEN
